...
<div class="card">
    <div class="card-body">
        <h4 class="page-title">
        <i class="mdi mdi-calendar-clock title_icon"></i>Subject  List
        <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle float-right" data-toggle="modal" data-target="#addModal"><i class="mdi mdi-plus"></i>Add New Subject</button>
        </h4>
    </div> 
</div>
<div class="card">
