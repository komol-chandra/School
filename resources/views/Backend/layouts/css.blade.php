...
<link rel="stylesheet" type="text/css" href="{{asset('Backend_assets/assets/libs/select2/dist/css/select2.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('Backend_assets/assets/libs/jquery-minicolors/jquery.minicolors.css')}}">
