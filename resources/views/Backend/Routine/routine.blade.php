...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4 col-sm-4 mb-1">
                <select name="section_name" class="select2 form-control custom-select" id="filterSection" onchange="datalist()">
...
@endsection
@section('js')
<script src="{{asset('Backend_assets/js/dynamic_routine.js')}}"></script>
@endsection
